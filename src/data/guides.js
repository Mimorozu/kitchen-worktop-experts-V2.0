// src/data/guides.js
// Ported from the quartz-worktop-finder-uk guides library — content kept as-is;
// the two marketplace-style CTAs were pointed at this business's own quote form
// since this site is a single fabricator, not a directory of installers.
...
export const GUIDES = [
  ...
  },
  {
    ...
    content: [
      ...
      p(
        'Really, even if you go with a plain grey colour with simple edge finishes, you will be looking around the £2700 (incl VAT) mark.'
      ),
      ...
      list([
        ...
        'Fabricator vs middleman — buying through a kitchen showroom often adds a margin on top of the fabricator doing the actual work. Going direct to a fabricator/installer can save 10–25%. [Get a free quote from us](/#quote).',
      ]),
      p(
